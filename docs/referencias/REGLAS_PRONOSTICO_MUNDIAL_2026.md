...
- Los pronósticos deben enviarse **antes de la 23:59 del día anterior al partido**.
- A partir de la las 23:59, los pronósticos de todos los participantes se **mostrarán públicamente** y ya **no pueden modificarse**.
...
- **Pronósticos de Partidos:** 
  - Antes de la las 23:59 del día anterior a cada partido: son **privados**.
  - Después de las 15:00: los pronósticos de **todos los participantes se hacen visibles**. Si no llenaron, dice "No pronosticó".
- Nadie puede modificar su pronóstico una vez publicado (pasadas las 23:59).
- **Fallback en WhatsApp:** Se habilitará un grupo de WhatsApp oficial. Si la app falla por algún motivo, los participantes pueden enviar su pronóstico por el grupo hasta las 23:59 del día anterior y el organizador actualizará la app cuando se restablezca.
...
Por cada partido:
  ...
  • Plazo: 23:59 del día anterior (Si olvida: 0-0 automático, max 1 pt)
  • A las 23:59 → pronósticos se publican y se bloquean
    ↓
...
| **Fixture** | Lista de partidos con fecha/hora, con plazo calculado automáticamente (23:59 del día anterior) |
